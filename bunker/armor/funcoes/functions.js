...
const ceemde = JSON.parse(fs.readFileSync('./bunker/database/data/totalcmd.json'));
...
const banner2 = cfonts.render((`GLEYSON BOTS`), {
font: 'console',
align: 'center',
gradient: ['red', 'magenta']
});
 
const banner3 = cfonts.render((`KITAGAWA - V8`), {
  font: 'block',
  align: "center",
  gradient: ['red', 'magenta']
});
